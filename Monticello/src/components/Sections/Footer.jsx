...
import bgFooter from "../../assets/backgrounds/bg_footer.png";

const Footer = () => {
  return (
    <footer
      id="footer"
      className="relative scroll-mt-[6.8rem] md:scroll-mt-[55vh]"
    >
      <img src={bgFooter} className="absolute inset-0 h-full w-full" />
